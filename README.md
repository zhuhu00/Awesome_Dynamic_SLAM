...
- (CVPR 2026) [DROID-SLAM in the Wild](https://openaccess.thecvf.com/content/CVPR2026/html/Li_DROID-SLAM_in_the_Wild_CVPR_2026_paper.html) — real-time RGB SLAM using uncertainty-aware bundle adjustment for unknown dynamic objects and cluttered scenes; [code](https://github.com/MoyangLi00/DROID-W) and dataset.
...
- (ECCV NeuSLAM Workshop 2026) [QUORUM: Multi-View Feature Consensus for Open-Vocabulary SLAM in Dynamic Scenes](https://be2rlab.github.io/quorum_site/) — monocular semantic SLAM with temporal feature consensus for separating static surfaces from moving objects; [code](https://github.com/be2rlab/QUORUM).
...
- (IEEE TCSVT 2025) [Semantic-Independent Dynamic SLAM Based on Geometric Re-Clustering and Optical Flow Residuals](https://doi.org/10.1109/TCSVT.2024.3496489) — handles unknown dynamic categories using geometric and motion cues; [code and RGB-D sequences](https://github.com/qimao7213/SInDSLAM).
...
- (CVPR 2026) [DROID-W Dataset](https://cvg-data.inf.ethz.ch/DROID-W) — seven casually captured outdoor sequences with dynamic objects, clutter, RGB frames, and LiDAR-derived ground-truth trajectories; [evaluation code](https://github.com/MoyangLi00/DROID-W).
